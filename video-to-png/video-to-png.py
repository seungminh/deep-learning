...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_video", type=str, help="영상데이터 입력")
    parser.add_argument("--fps", type=int, default=25, help="영상의 대략적인 fps값을 입력")
    parser.add_argument("--custom_data_path", type=str, default="/Users/seungmin/Projects/trainer/PyTorch-YOLOv3/data/custom/images", help="이미지가 저장될 경로를 입력")
...
print("초당 {0}의 프레임마다 비디오를 나누어 캡쳐합니다.".format(opt.fps))
